...
public class ReviewController {
    ...
    public String listByPage(@PagingAndSortingParam(listName = "listReviews")PagingAndSortingHeper heper,
                             @PathVariable(name = "pageNum") int pageNum){
        reviewService.listByPage(pageNum, heper);
    ...
    public String saveReview(Review reviewInform, RedirectAttributes rs){
        ...
        rs.addFlashAttribute("message", "The review ID " + reviewInform.getId() + " has been updated successfully.");
        return defaultRedirectURL;
    }
    ...
    public String deleteReview(@PathVariable("id") Integer id, RedirectAttributes rs){
        try {
            ...
            rs.addFlashAttribute("message","The review ID " + id + " has been deleted.");
        } catch (ReviewNotFoundException ex){
            rs.addFlashAttribute("message",ex.getMessage());
        }
